...
import { TextField, Box, Alert, CircularProgress, Button } from '@mui/material';
...
const Register = () => {
  ...
  return (
    <div className="min-h-screen flex items-start justify-center bg-gradient-to-br from-blue-50 to-indigo-100 px-4 sm:px-6 lg:px-8 py-4">
